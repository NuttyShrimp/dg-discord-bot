...
class TeamSpeak extends events_1.EventEmitter {
     ...
     */
    clientKick(client, reasonid, reasonmsg) {
        return this.execute("clientkick", { clid: Client_1.TeamSpeakClient.getId(client), reasonid, reasonmsg });
    }
    /**
    ...
    banClient(properties) {
        return this.execute("banclient", properties)
            .then(TeamSpeak.singleResponse);
    }
    /**
