...
export declare type ClientList = ClientEntry[];
...
export declare type ChannelList = ChannelEntry[];
...
export declare type ServerGroupList = ServerGroupEntry[];
...
export declare type ChannelClientPermIdList = ChannelClientPermIdEntry[];
...
export declare type ChannelClientPermSidList = ChannelClientPermSidEntry[];
...
export declare type ChannelGroupList = ChannelGroupEntry[];
...
export declare type ServerList = ServerEntry[];
...
export declare type QueryLoginList = QueryLoginEntry[];
...
export declare type ServerGroupClientList = ServerGroupClientEntry[];
...
export declare type ChannelGroupClientList = ChannelGroupClientEntry[];
export interface ChannelGroupClientEntry extends TeamSpeakQuery.ResponseEntry {
    cid?: string;
    cldbid?: string;
    cgid?: string;
}
export declare type PermList = PermEntry[];
...
export declare type ClientGetIds = ClientGetIdEntry[];
...
export declare type ClientDBList = ClientDBEntry[];
...
export declare type PermOverview = PermOverviewEntry[];
...
export declare type PermissionList = PermissionEntry[];
...
export declare type PrivilegeKeyList = PrivilegeKeyEntry[];
...
export declare type MessageList = MessageEntry[];
...
export declare type ComplainList = ComplainEntry[];
...
export declare type BanList = BanEntry[];
...
export declare type FTList = FileTransferEntry[];
...
export declare type FTGetFileList = FTGetFileEntry[];
