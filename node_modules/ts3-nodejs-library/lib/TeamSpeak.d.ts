...
export declare class TeamSpeak extends EventEmitter {
     ...
     */
    clientKick(client: TeamSpeakClient.ClientType, reasonid: ReasonIdentifier, reasonmsg: string): Promise<[]>;
    /**
     ...
     */
    clientMove(client: TeamSpeakClient.ClientType, channel: TeamSpeakChannel.ChannelType, cpw?: string): Promise<[]>;
    /**
